...
**Nhóm:** MegaLive  
**Thành viên:** Hà Huy Nhật (02401), Đinh Xuân Quyền (2A202602358), Ngụy Quang Hùng (2A202602998), Nguyễn Văn Việt  
**Ngày:** 2026-09-19
...
- **Loại chiến lược:** Sentence/recursive chunking cho câu hỏi chính sách ngắn.
- **Mô tả & lý do chọn:** Report cá nhân mô tả cả `SentenceChunker` và `RecursiveChunker`, trong đó retrieval tập trung vào các câu trả lời ngắn, rõ ràng như “Hệ Chuẩn thu theo tín chỉ”, “Cảnh cáo tối đa loại Trung bình”, “Xuất sắc: 90 - 100 điểm”. Cách này phù hợp với bộ câu hỏi benchmark vì phần lớn đáp án nằm trong một hoặc vài câu liên tiếp.
- **Code snippet (nếu custom):**
```python
...
|-----------|----------|----------------------|-----------|----------|
| Hà Huy Nhật | FixedSize, `chunk_size=500`, `overlap=50`, Gemini | 10/10 | Dễ triển khai, ổn định, 5/5 câu có chunk liên quan trong top-3. | Một số câu đúng nằm ở top-2/top-3 vì cắt chưa theo cấu trúc mục. |
| Đinh Xuân Quyền | SentenceChunker, OpenAI | 10/10 | Giữ nguyên câu chứa đáp án, rất tốt với các câu hỏi có câu trả lời ngắn và trực tiếp. | Có thể thiếu tiêu đề/mục cha nếu một câu cần thêm bối cảnh từ heading. |
| Ngụy Quang Hùng | Sentence/recursive chunking | 10/10 | Phù hợp với câu hỏi ngắn, nhiều đáp án nằm trực tiếp trong một câu hoặc một mục nhỏ. | Một số mô tả chiến lược trong report còn chung, chưa tách rõ cấu hình chunking cuối cùng. |
